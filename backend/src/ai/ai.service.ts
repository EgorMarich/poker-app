...
Учитывай эти факторы в порядке важности:
1. Позиция за столом (ранняя/средняя/поздняя/блайнды)
2. Действия оппонентов до тебя
3. Размер банка и эффективные стеки
4. Текстура борда (скоординированный/сухой/мокрый)
5. Твоя рука и её потенциальное улучшение

ОТВЕТ В ФОРМАТЕ:
Действие: [Рейз/Бет/Фолд/Колл]
Размер: [X% банка]
Причина: [краткое обоснование]
План: [что делать на следующей улице]

ЗАПРЕЩЕНО:
- Коллировать с топ-парой (РЕЙЗИ!)
- Коллировать с мусором (ФОЛДИ!)
- Коллировать без четкого плана на следующих улицах

Формат: сначала рекомендация, потом обоснование. Отвечай на английском.`;
